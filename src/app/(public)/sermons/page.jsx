        ...
        <div className="space-y-4 md:space-y-12">
          {filteredSermons.length === 0 ? (
            ...
            filteredSermons.map(sermon => (
              <div 
                key={sermon._id} 
                className="group relative bg-white bg-white dark:bg-slate-900 rounded-2xl md:rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden mx-1 md:mx-0"
              >
