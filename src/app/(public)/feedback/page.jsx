  ...
  const categories = [
    {
      ...
      bgColor: 'bg-blue-500/50 dark:bg-slate-800/50',
    ...
    },
    {
      ...
      bgColor: 'bg-purple-500/50 dark:bg-slate-800/50',
      borderColor: 'border-purple-100 dark:border-slate-700',
    ...
    },
    {
      ...
      bgColor: 'bg-amber-500/50 dark:bg-slate-800/50',
      borderColor: 'border-amber-100 dark:border-slate-700',
    ...
    },
    {
      ...
      bgColor: 'bg-emerald-500/50 dark:bg-slate-800/50',
    ...
    },
    {
      ...
      bgColor: 'bg-red-500/50 dark:bg-slate-800/50',
      borderColor: 'border-red-100 dark:border-slate-700',
    ...
    },
    {
      ...
      bgColor: 'bg-slate-500/50 dark:bg-slate-800/50',
          ...
          <div className="max-w-7xl mx-auto">
            <header className="text-center mb-8">
              <h1 className="text-5xl font-black text-slate-900 dark:text-white mb-4 tracking-tight">
                We Value Your <span className="text-[#8B1A1A] dark:text-red-600">Voice.</span>
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {categories.map((cat) => (
                ...
                >
                  <div className="mb-6 p-4 bg-white dark:bg-slate-800 rounded-2xl shadow-sm group-hover:scale-110 transition-transform duration-300">
                    {cat.icon}
                  </div>
                  <h3 className={`text-2xl font-bold mb-3 ${cat.accent}`}>{cat.title}</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-8">{cat.description}</p>
          ...
          <div className="px-6 md:px-0 pt-6 md:pt-0">
            <div className="max-w-3xl mx-auto">
              <button 
                ...
                className="flex items-center gap-2 text-slate-400 dark:text-slate-400 hover:text-[#8B1A1A] dark:hover:text-red-600 transition-colors mb-8 font-bold uppercase text-xs tracking-widest"
              >
