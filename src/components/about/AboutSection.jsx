        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-slate-100 flex flex-col lg:flex-row">
            <div className="lg:w-1/2 p-12 md:p-16 space-y-8">
              ...
              <h2 className="text-5xl font-black text-slate-900 leading-tight">Welcome to <span className="text-[#8B1A1A]">H.O.T</span></h2>
            ...
            <div className="lg:w-1/2 relative min-h-[400px]">
              <img src={churchImages[0].url} className="absolute inset-0 w-full h-full object-cover" alt="H.O.T Worship" />
            </div>
          </div>
        </div>
      </section>
    ...
    <div className="bg-[#F8FAFC] pb-32">
      ...
      <section className="pt-20 pb-10 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-6">
          <div className="lg:col-span-8 bg-white p-12 md:p-20 rounded-[3rem] shadow-sm border border-slate-100 flex flex-col justify-center">
          ...
          <div className="lg:col-span-4 bg-[#8B1A1A] rounded-[3rem] p-10 flex flex-col justify-between text-white shadow-xl">
      ...
      <section className="max-w-7xl mx-auto px-6 py-10 grid lg:grid-cols-12 gap-6">
        <div className="lg:col-span-4 rounded-[3rem] overflow-hidden shadow-sm h-[500px]">
          <img src={churchImages[0].url} className="w-full h-full object-cover" alt="Worship" />
        </div>
        <div className="lg:col-span-8 bg-white p-12 md:p-16 rounded-[3rem] shadow-sm border border-slate-100 space-y-8">
      ...
      <section className="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-2 gap-6">
        <div className="bg-white p-12 rounded-[3rem] shadow-sm border border-slate-100 space-y-6 hover:border-[#8B1A1A]/30 transition-colors">
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="bg-slate-900 rounded-[4rem] p-12 md:p-20">
          <h2 className="text-4xl font-black text-white text-center mb-16">Our Core Beliefs</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="flex gap-6 items-start group">
                ...
                <p className="text-slate-300 font-bold leading-snug">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-[3rem] p-12 md:p-20 shadow-sm border border-slate-100">
          <div className="grid lg:grid-cols-12 gap-16">
            <div className="lg:col-span-4 space-y-4">
              <History size={48} className="text-[#8B1A1A]" />
              <h2 className="text-4xl font-black text-slate-900">Our History</h2>
              <p className="text-slate-500 font-bold uppercase tracking-widest text-xs">A Legacy of Grace</p>
            </div>
            <div className="lg:col-span-8 space-y-12">
              <div className="space-y-4 border-l-4 border-slate-50 pl-8">
                <h4 className="text-xl font-black text-[#8B1A1A]">The Birth in Nairobi (1989)</h4>
                <p className="text-slate-600 text-lg leading-relaxed">
                  Founded around 1989 as Nairobi Gospel Assembly Church, House of Transformation Ministries began as a place of vibrant worship and community outreach in Nairobi, Kenya. Under visionary leadership, the church rebranded to emphasize its mission of preaching the Kingdom Gospel.
                </p>
              </div>
              <div className="space-y-4 border-l-4 border-[#8B1A1A] pl-8">
                <h4 className="text-xl font-black text-[#8B1A1A]">Expansion to Busia</h4>
                <p className="text-slate-600 text-lg leading-relaxed">
                  The Busia Main Campus was established as a key outreach in western Kenya, addressing the unique needs of diverse communities including the Luhya and Iteso people. It has become a thriving hub for powerful services and youth empowerment.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <h2 className="text-4xl font-black text-slate-900 text-center mb-16">Our Leadership</h2>
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 text-center space-y-4">
              <img src={leader.img} className="w-32 h-32 mx-auto rounded-3xl object-cover shadow-md" alt={leader.name} />
              <div>
                <h4 className="text-xl font-black text-slate-900">{leader.name}</h4>
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="bg-white rounded-[3rem] p-12 md:p-20 shadow-sm border border-slate-100 text-center space-y-10">
          <h2 className="text-5xl font-black text-slate-900">Experience the <br /><span className="text-[#8B1A1A]">Transformation</span></h2>
          <div className="flex flex-wrap justify-center gap-10 text-slate-500 font-bold">
          ...
          <Button variant="secondary" className="bg-[#8B1A1A] text-white rounded-2xl px-12 py-6 font-black uppercase text-sm tracking-[0.2em] shadow-lg shadow-red-900/20">
